...
public class MQTTManager {
    public static final String SERVER_HOST = "tcp://192.168.123.226:61613";
    private String clientid = "text_ip_1";
    ...
    public static MQTTManager getInstance(Context context) {
        LogPlus.e("mqttManager=" + mqttManager);
        if (mqttManager == null) {
            mqttManager = new MQTTManager(context);
            synchronized (Object.class) {
                LogPlus.e("synchronized mqttManager=" + mqttManager);
                if (mqttManager != null) {
                    return mqttManager;
                }
            }
        } else {
            LogPlus.e("else mqttManager=" + mqttManager);
            return mqttManager;
        }
        return null;
    }
    ...
    public void connect() {
        ...
        try {
            ...
            LogPlus.e("ClientId=" + client.getClientId());
    ...
    public void publish(String topic, String msg, boolean isRetained, int qos) {
        ...
        try {
            if (client != null) {
                ...
                LogPlus.e("topic=" + topic + "--msg=" + msg + "--isRetained" + isRetained);
            }
    ...
    public class PushCallback implements MqttCallback {
        ...
        public void deliveryComplete(IMqttDeliveryToken token) {
            //publish后会执行到这里
            LogPlus.e("发布消息成功的回调" + token.isComplete());
        }
        ...
        public void messageArrived(final String topicName, final MqttMessage message)
            ...
            LogPlus.e("接收消息==" + new String(message.getPayload()));
            if (callBack != null) {
