package com.simonfong.app2.drawerlayout;
...
import com.simonfong.app2.MainActivity;
 ...
 * interface by
 */
public class DrawerLayoutActivity extends BaseCommonActivity {
    @Override
    ...
    private void setListener() {
        ...
        leftSideBar.setFantasyListener(new SimpleFantasyListener() {
            ...
            public boolean onSelect(View view, int index) {
                ...
                Toast.makeText(DrawerLayoutActivity.this, String.format("%d selected", index), Toast.LENGTH_SHORT).show();
                return false;
            }
    ...
    public void onClick(View view) {
        if (view instanceof TextView) {
            ...
            if (title.startsWith("星期")) {
                ...
                Toast.makeText(this, "sdfasdfasd", Toast.LENGTH_SHORT).show();
            }
