package cn.dlc.zizhuyinliaoji.myapplication.addImage.ui;
...
public class AddPicView extends LinearLayout {
    ...
    class AddPicAdapter extends BaseRecyclerAdapter<String> {
        ...
        public void onBindViewHolder(CommonHolder holder, final int position) {
            ImageView image = holder.getImage(R.id.iv_pic);
            ImageView closeIv = holder.getImage(R.id.iv_close);
